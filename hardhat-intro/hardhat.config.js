...
task("copy")
    ...
    .setAction(async (taskArgs) => {
        ...
        const data = JSON.parse(fs.readFileSync("./out.json").toString());
        const contract = data.contracts[name];
        ...
        fs.writeFileSync("../scaffold/packages/react-app/src/contracts/" + name + ".address.js", 'module.exports = "' + contract.address + '";')
        fs.writeFileSync("../scaffold/packages/react-app/src/contracts/" + name + ".bytecode.js", 'module.exports = "' + contract2.deployedBytecode + '";')
    });
